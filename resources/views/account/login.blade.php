                            ...
                            <div class="ts_panel_form">
                                <form name="ts_login_form" id="ts_login_form" method="post" action="{{ URL::route('UserLogin') }}">
                                    ...
                                    <div class="fields checBoxFields">
                                        ...
                                        @endif
                                        Remember me</label>
                                        <a href="{{ URL::route('ForgotPassword') }}<?php if(isset($_GET['noheader'])){ echo "?noheader&nofooter"; } ?>" class="forgotPass">Forgot Password</a>
                                    </div>
                                    <!---->
                                    <div class="submitBlk">
                                        ...
                                        <div class="fields social">                                
                                            <?php                               
												...
												if(isset($_GET['noheader'])){
													 echo '<a class="facebook"  target="_blank"  href="'.$login_url.'">Sign in  with Facebook</a>';
												}else{
                                    ...
                                    <div class="col-md-5">
                                        <div class="fields social">
                                            <?php                               
                                                ...
                                                $login_url = $fb->getLoginUrl(['email']);
												if(isset($_GET['noheader'])){
													 echo '<a class="facebook fbLogin"  target="_blank" id="student" href="'.$login_url.'">Sign Up  with Facebook</a>';
												}else{
                                    ...
                                    <div class="col-md-5">
                                        <div class="fields social">
                                            <?php                               
                                                ...
                                                $login_url = $fb->getLoginUrl(['email']);
												if(isset($_GET['noheader'])){
													 echo '<a target="_blank" class="facebook fbLogin"  id="training institute manager" href="'.$login_url.'">Sign Up  with Facebook</a>';
												}else{
                                    ...
                                    <div class="col-md-5">
                                        <div class="fields social">                                
                                            <?php                               
                                                ...
                                                $login_url = $fb->getLoginUrl(['email']);
												if(isset($_GET['noheader'])){
													 echo '<a target="_blank" class="facebook fbLogin"  id="trainer" href="'.$login_url.'">Sign Up  with Facebook</a>';
												}else{
 ...
 $(document).ready(function(){
   ...
   $("#ts_login_form").validate({
		...
		submitHandler: function(form) { 
			...
			$.ajax({
				url: '/account/login<?php if(isset($_GET['noheader'])){ echo "?redirect_url=reload"; } ?>',
				type: 'POST',
				data: formData,
				dataType: "json",
				success: function (data) {
					...
					if(data.status == 'success') {
						if(data.redirect_url == '/course/list/'){
