        ...
        <div class="col-md-8 text-center col-md-offset-2">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="text-center">We hand pick the Training Programs and Institutes closer to your location, who are Passionate and prepare you for the future of your choice.</p>
                </div>
            </div>
                ...
                <div class="col-md-8 text-center col-md-offset-2">
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            ...
                            <p class="text-center">Training Programs</p>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-4">
...
<div class="container body-spc-aligned">
        ...
        <div class="col-md-12 content-section">
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <p class="primary-color our-aim">Our aim is to enable you towards a bright future. So whichever path you choose through us, be assured that it brings you closer to your intended goal.</p>
                
                </div>
                <div class="col-md-5">
                    <p>Choose from wide array of Training Programs near you that are meant to prepare you for the future. Search based on Interest, Location, Duration, Facilities (Women Only), Accomodation and other benefits, the Program has to offer including Free and subsidized courses.</p>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row head-section">
                <div class="col-md-12">
                    <h3 class="section-title"><i class="fa fa-university primary-color"></i>Buddhijeevi for CSR, Implementation Bodies and Institutes</h3>
                </div>
            </div>
            <div class="row content-section">
                <div class="col-md-5">
                    <h2><b>Student Mobilization and Salesforce Solution</b></h2>
                    <h4><b>Your Salesforce engine for student mobilization and retention strategy</b></h4>
                    ...
                    <p>We understand the ground level challenges and we have solution to address the same. Through our unique Marketplace solution supported with local language(s) and community support will help in articulating the benefits the program has to offer in a very effective way. You can Monitor the entire program sitting on your Desk.</p>
                    
                    <blockquote class="primary-color">
                        <i class="fa fa-quote-left" aria-hidden="true"></i>
                        We found the Platform to be very interactive and Precise. Overall, it’s an innovative idea to bring Training Programs and Students together
                ...
                <div class="col-md-5 col-md-offset-1">
                    ...
                    <div class="row text-center icon-group-block">
                        <div class="col-md-4 col-sm-4 col-xs-4">   
                            ...
                            <p>Multiple Training Programs</p>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-4"> 
