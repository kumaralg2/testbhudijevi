<nav class="navbar" style="<?php if(isset($_GET['noheader'])){ echo "display:none"; } ?>" >
    <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                @if(Auth::check()) 
					@if( Auth::user()->nUsrRoleID == 1005 || Auth::user()->nUsrRoleID == 1006 )
						<li {{{ (Request::is('student-registration') ? 'class=active' : '') }}}>
                            <a title="Courses" href="{{URL::route('StudentRegistation')}}">Student Registration</a>
                        </li>
					@endif	
                    ...
                    <li>
                        ...
                        <ul class="dropdown-menu">
							@if( Auth::user()->nUsrRoleID == 1002 )
							 <li>
                                  <a href="{{URL::to('account/view-institute-profile/')}}/<?php echo Auth::user()->ausrid; ?>">My Profile</a>
                            </li>
							@elseif( Auth::user()->nUsrRoleID == 1003 )
							 <li>
                                 <a href="{{URL::to('account/view-trainer-profile/')}}/<?php echo Auth::user()->ausrid; ?>">My Profile</a>
                            </li>
							@elseif( Auth::user()->nUsrRoleID == 1004 )
							 <li>
                                 <a href="{{URL::to('account/view-student-profile/')}}/<?php echo Auth::user()->ausrid; ?>">My Profile</a>
                            </li>							
							@endif
							@if( Auth::user()->nUsrRoleID == 1001 )
							 <li>
                                 <a href="{{URL::to('admin/affiliate-user/add')}}">Create Affiliate User</a>
                            </li>
							@else
							<li>
                                 <a href="{{URL::route('UserProfile')}}">Update Profile</a>
                            </li>
							@endif
