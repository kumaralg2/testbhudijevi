					...
					<ul class="">
						...
						<div class="col-md-12">						
							<form>
							  ...
							  <input type="text" class="form-control" id="text" value="<?php echo $degree_master->tDegree; ?>" placeholder="Enter Degree" name="text">
							</div>		
							  <div class="form-group">
							  <label for="text">Sort:</label>
							  <input type="text" class="form-control" id="text" value="<?php echo $degree_master->sort_order; ?>" placeholder="Enter sorting number ( Optional )" name="text">
							</div>								  						 
