					...
					<ul class="">
						...
						<div class="col-md-12">						
							<table class="table">
							 ...
							 <?php for($i=0;$i<count($institute_list);$i++) {  ?>
							  <tr>
								<td><?php echo $institute_list[$i]->aInstituteID; ?></td>
								<td><?php echo $institute_list[$i]->tInstituteName; ?></td>
								<td><?php echo $institute_list[$i]->tUsrFName; ?></td>
								
								<td><a href="">More Info</a></td>
							  </tr>
							 <?php } ?>
							  </table>
							 <?php echo $institute_list->render(); ?>
						</div>
