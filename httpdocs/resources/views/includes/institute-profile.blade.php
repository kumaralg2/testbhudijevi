    ...
    <div class="row">
      ...
      <div class="col-md-3">
          ...
          <div class="subCategoriesBlk studentProfile">
			   ...
			   <h2>Enrollments and Contracts</h2>
            <ul>
            <?php if(Auth::user()->nUsrRoleID != 1004): ?>
                <li><a href="tsSubscriptions">Contracts</a><span>List of Active and Expired contracts with us. </span></li>
            <?php endif; ?>
            <?php if(Auth::user()->nUsrRoleID == 1001 || Auth::user()->nUsrRoleID == 1002 ): ?>
             	...
             	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="infoTable">
                  ...
                  <?php
                    ...
                    $getInstitution = DB::table('tblinstitutemaster')
                                            ...
                                            ->get();
                    if($getInstitution && Auth::user()->nUsrRoleID != 1003){
                  ...
                  @endforeach
                  <?php } else if(!$getInstitution && Auth::user()->nUsrRoleID == 1003) {
        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
            ...
            <div class="col-md-12">
              <div class="fields submitFields">
                ...
                <input type="submit" class="blueBtn" name="save" alt="Save" value="Save" id="saveInsAddress" <?php echo ($affiliation_status) ? 'disabled': '' ?> />
               <a class="goBackBtn" href="/account/profile">Cancel</a>
              </div>
            </div>
            </form>
