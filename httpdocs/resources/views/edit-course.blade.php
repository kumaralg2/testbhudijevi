	...
	<div class="container cbc">
      ...
      <div class="col-md-8">
        <div class="takshaInfo">
          <form action="" method="" id="EditCourse">
                ...
                <div class="profileBox img-responsive">
                    <img src="/assets/images/{{$course->tImageFileName}}">				  
                </div>
            ...
            <div class="col-md-6">
              <div class="fields">
                ...
                <input type="text" value="{{$course->tCoursetitle}}"  id="title" name="title"  />
				  <input type="hidden" value="{{$course->tImageFileName}}" name="image_filename" class="image_filename">
              </div>
              <div class="fields">
                <label for="subTitle">Sub Title* ?</label>
                <input type="text" value="{{$course->tCoursesubtitle}}" id="subTitle" name="subTitle"  />
              </div>
            </div>
            <div class="col-md-6">
              <div class="fields">
              ...
              <div class="fields">
				...
				?>
                <select class="" name="sectorBlk" onchange="getCategory(this.value)">
                  <option value="">Select</option>
            ...
            <div class="col-md-12">
              <div class="fields radioRow">
                ...
                <input type="radio" value="{{$complexity->aCoursecomplexityMasterID}}" id="{{$complexity->tCourseComplexity}}" name="bie" <?php if($course->nCourseComplexityID == $complexity->aCoursecomplexityMasterID){ echo "checked"; } ?>>
                </label>
				 @endforeach
              </div>
            </div>
			<div class="col-md-6">
			   ...
			   <div class="col-md-6">
                ...
                <select class="dropdow" name="jobRoles" id="Interest">
				<?php
            ...
            <div class="col-md-12">
              <div class="fields">
                ...
                <textarea maxlength="250" class="jqte-test" id="summary" rows="5" cols="5" name="summary">{{$course->tCoursedescription}}</textarea>
              </div>
            </div>
